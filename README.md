...
本课题研究和开发社区医疗保健监控系统，让安装在计算机上的该系统变成管理人员的小帮手，提高社区医疗保健信息处理速度，规范社区医疗保健信息处理流程，让管理人员的产出效益更高。
## 1.2 课题意义
传统处理数据，必须是一张张纸，然后处理完毕又是统计在一张张纸上面，不断的重复处理，最终有个结果给最高层作为参考，这个模式在互联网没有出现之前，是一种常见的事情，信息管理的效率提不上去，人多不一定力量大，因为人多肯定更加消耗资源，并且因为人类需要休息，需要管理，思想会不统一，会偷懒，所以人们研究出专门帮助人们计算的机器，就是计算机的前身，到了互联网时代，人们发现完全可以让程序供应商提供解决方案，自己挑选自己合适的方案来提高自己的产出比。所以在日常工作和生活中会发现各种各样方便人们的工具。

本课题研发的社区医疗保健监控系统，就是提供社区医疗保健信息处理的解决方案，它可以短时间处理完信息，并且这些信息都有专门的存储设备，而且数据的备份和迁移都可以设定为无人值守，从人力角度和信息处理角度以及信息安全角度，社区医疗保健监控系统是完胜传统纸质操作的。
## 1.3 研究内容
本文对社区医疗保健监控系统的设计与实现分成六个章节来说明。

第1章：研究社区医疗保健监控系统的背景，以及开发社区医疗保健监控系统的意义。

第2章：对开发社区医疗保健监控系统的环境还有技术进行说明。

第3章：分析社区医疗保健监控系统的可行性，性能，流程以及功能。

第4章：设计社区医疗保健监控系统的功能结构，设计数据库E-R图以及对数据表的存储结构进行设计。

第5章：实现社区医疗保健监控系统的功能并进行功能界面展示。

第6章：对系统测试进行阐述，以及对本系统部分功能进行检测。
# 第2章 开发环境与技术
本章节对开发社区医疗保健监控系统需要搭建的开发环境，还有社区医疗保健监控系统开发中使用的编程技术等进行阐述。
## 2.1 Java语言  
...
图4.2即为设计的医生功能结构，医生权限操作的功能包括管理病例信息，管理用户预约医生的信息，查看社区公告以及药品信息。
